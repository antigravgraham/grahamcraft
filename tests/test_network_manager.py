...
class TestNetworkManager(unittest.TestCase):
    ...
    def test_send_voxel_place_when_connected(self, mock_color):
        ...
        expected_data = {"position": [1.0, 2.0, 3.0], "color": [1.0, 0.5, 0.2]}
    ...
    def test_send_voxel_destroy_when_connected(self):
        ...
        self.network_manager.sio.emit.assert_called_once_with(
            "voxel_destroy", {"position": position}
        )
    ...
    def test_send_world_save(self):
        ...
        self.network_manager.sio.emit.assert_called_once_with(
            "world_save", {"filename": "test_world.json"}
        )
    ...
    def test_send_world_load(self):
        ...
        self.network_manager.sio.emit.assert_called_once_with(
            "world_load", {"filename": "test_world.json"}
        )
    ...
    def test_load_game_state(self, mock_color, mock_multiplayer_player, mock_voxel, mock_destroy):
        ...
        mock_voxel.side_effect = [
            mock_voxel_instance1,
            mock_voxel_instance2,
            mock_voxel_instance1,
            mock_voxel_instance2,
        ]
        ...
        mock_multiplayer_player.assert_called_once_with(
            position=(10, 10, 10), player_id="remote_player"
        )
