...
class TestWorldManager(unittest.TestCase):
    ...
    def test_save_world_default_filename(self, mock_print, mock_pickle_dump, mock_file):
        ...
        mock_pickle_dump.assert_called_once_with(expected_data, mock_file.return_value.__enter__.return_value)
    ...
    @patch('builtins.print')
    def test_load_world_success(self, mock_print, mock_voxel_class, mock_destroy, 
    ...
    @patch('grahamcraft.world_manager.destroy')
    @patch('grahamcraft.world_manager.Voxel')
    def test_load_world_with_gravity(self, mock_voxel_class, mock_destroy, 
                                   mock_pickle_load, mock_file, mock_exists):
    ...
    @patch('grahamcraft.world_manager.Voxel')
    @patch('builtins.print')
    def test_load_world_custom_filename(self, mock_print, mock_voxel_class, mock_destroy, 
                                      mock_pickle_load, mock_file, mock_exists):
